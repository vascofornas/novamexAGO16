$(document).ready(function(){
  ...
  var table_companies = $('#table_companies').dataTable({
    "ajax": "data_mensajes_recibidos.php?job=get_companies",
    "columns": [
  ...
  $(document).on('submit', '#form_company.add', function(e){
    ...
    if (form_company.valid() == true){
      ...
      var request   = $.ajax({
        url:          'data_mensajes_recibidos.php?job=add_company',
        cache:        false,
        data:         form_data,
        dataType:     'json',
      ...
      request.done(function(output){
        if (output.result == 'success'){
          ...
          table_companies.api().ajax.reload(function(){
            ...
            var company_name = $('#titulo').val();
            show_message("Message with Title '" + company_name + "' added sucessfully.", 'success');
          }, true);
        } else {
          hide_loading_message();
  ...
  $(document).on('click', '.function_edit a', function(e){
    ...
    var id      = $(this).data('id');
    var request = $.ajax({
      url:          'data_mensajes_recibidos.php?job=get_company',
      cache:        false,
      data:         'id=' + id,
      dataType:     'json',
      contentType:  'application/json; charset=utf-8',
    ...
    request.done(function(output){
      if (output.result == 'success'){
        $('.lightbox_content h2').text('Read Message');
        $('#form_company button').text('Read Message');
  ...
  $(document).on('submit', '#form_company.edit', function(e){
    ...
    if (form_company.valid() == true){
      ...
      var form_data = $('#form_company').serialize();
      var request   = $.ajax({
        url:          'data_mensajes_recibidos.php?job=edit_company&id=' + id,
        cache:        false,
        data:         form_data,
        dataType:     'json',
        contentType:  'application/json; charset=utf-8',
      ...
      request.done(function(output){
        if (output.result == 'success'){
          ...
          table_companies.api().ajax.reload(function(){
            hide_loading_message();
            var company_name = $('#titulo').val();
            show_message("Message with title '" + company_name + "' read succesfully.", 'success');
          }, true);
        } else {
          hide_loading_message();
  ...
  $(document).on('click', '.function_delete a', function(e){
    ...
    if (confirm("Do yo want to delete Message with title '" + company_name + "'?")){
      ...
      var id      = $(this).data('id');
      var request = $.ajax({
        url:          'data_mensajes_recibidos.php?job=delete_company&id=' + id,
        cache:        false,
        dataType:     'json',
        contentType:  'application/json; charset=utf-8',
        type:         'get'
      ...
      request.done(function(output){
        if (output.result == 'success'){
          ...
          table_companies.api().ajax.reload(function(){
            hide_loading_message();
            show_message("Message with title '" + company_name + "' deleted successfully.", 'success');
          }, true);
        } else {
          hide_loading_message();
