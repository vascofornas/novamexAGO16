$(document).ready(function(){
  ...
  var table_companies = $('#table_companies').dataTable({
    ...
    "oLanguage": {
      ...
      "sLengthMenu":    "Number of Department s to show: _MENU_",
      "sInfo":          "Total of _TOTAL_ departments (showing from _START_ to _END_)",
  ...
  $(document).on('click', '#add_company', function(e){
    ...
    $('#form_company button').text('Add Department');
      ...
      request.done(function(output){
        if (output.result == 'success'){
          ...
          table_companies.api().ajax.reload(function(){
            ...
            show_message("Department with Title '" + company_name + "' added sucessfully.", 'success');
          }, true);
        } else {
          hide_loading_message();
  ...
  $(document).on('click', '.function_edit a', function(e){
    ...
    request.done(function(output){
      if (output.result == 'success'){
        ...
        $('#form_company button').text('Edit Department');
