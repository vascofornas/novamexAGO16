...
echo $porcentaje1."-".$porcentaje2."-".$porcentaje3."-".$porcentaje4."-".$porcentaje5."-".$porcentaje6."-".$porcentaje7."-".$porcentaje7."-".$porcentaje9."-".$porcentaje10;
}
...
VALUES ('$id','Revision # .$num')";
	...
	$sql1 = "INSERT INTO tb_evaluaciones_proyectos (revision_evaluada,porcentaje_evaluado,opcion_evaluada,proyecto_evaluado)
	VALUES ('$last_id','$porcentajetipo1','$opcion1','$id')";
...
if ($num >0){
	echo '<a href="#" class="btn btn-primary btn-lg active" role="button">'.$lang['CONFIGURAR_REVISIONES'].'</a>';
}
