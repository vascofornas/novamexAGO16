...
if ($job != ''){
  ...
  if ($job == 'get_companies'){
    ...
    // Get companies
    $query = "SELECT * FROM tb_datos_configuracion";
    ...
    if (!$query){
      ...
      while ($company = mysqli_fetch_array($query)){
        ...
        $mysql_data[] = array(
          ...
          "superadmin_email"  => $company['superadmin_email'],
                    "functions"     => $functions
        );
      }
    }
    ...
    if ($id == ''){
      ...
      $query = "SELECT * FROM tb_datos_configuracion WHERE id = '" . mysqli_real_escape_string($db_connection, $id) . "'";
      $query = mysqli_query($db_connection, $query);
      if (!$query){
        $result  = 'error';
        $message = 'query error';
    ...
    if ($id == ''){
      ...
      $message = 'id missing';
    	...
    	$miemail = get_email($_SESSION['userSession']);
    	add_log($texto,$miemail,$codigo);
      $query = "UPDATE tb_datos_configuracion SET ";
      if (isset($_GET['superadmin_email'])) { $query .= "superadmin_email = '" . mysqli_real_escape_string($db_connection, $_GET['superadmin_email']) . "'";    }
