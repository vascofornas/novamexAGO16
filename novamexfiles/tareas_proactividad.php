...
echo "<img class='blink-image' src='rojo.png' width='20' height='20' /><strong><a href='#'>  ".$row_proyectos['titulo_tareas_proactividad'] ."</strong></a><br> " . $row_proyectos['descripcion_tareas_proactividad']."<hr>";
	...
	if ($row_proyectos['cliente_tareas_proactividad'] == $row['userID'] AND $row_proyectos['estado_tareas_proactividad'] == 1  AND $row_proyectos['approved_by_supervisor'] == 0){
		echo "<img class='blink-image' src='rojo.png' width='20' height='20' /><strong><a href='#'>  ".$row_proyectos['titulo_tareas_proactividad'] ."</strong></a><br> " . $row_proyectos['descripcion_tareas_proactividad']."<hr>";
	}
	if ($row_proyectos['cliente_tareas_proactividad'] == $row['userID'] AND $row_proyectos['estado_tareas_proactividad'] == 1  AND $row_proyectos['approved_by_supervisor'] == 2){
		echo "<img class='blink-image' src='rojo.png' width='20' height='20' /><strong><a href='#'>  ".$row_proyectos['titulo_tareas_proactividad'] ."</strong></a><br> " . $row_proyectos['descripcion_tareas_proactividad']."<hr>";
	}
	if ($row_proyectos['cliente_tareas_proactividad'] == $row['userID'] AND $row_proyectos['estado_tareas_proactividad'] == 1 AND $row_proyectos['approved_by_supervisor'] == 1){
		echo "<img class='blink-image' src='verde.png' width='20' height='20' /><strong><a href='rci_a_evaluar.php?id=".$row_proyectos['id_tareas_proactividad']."'>  ".$row_proyectos['titulo_tareas_proactividad'] ."</strong></a><br> " . $row_proyectos['descripcion_tareas_proactividad']."<hr>";
	}
}
