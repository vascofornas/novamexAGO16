  ...
  if ($job == 'get_companies'){
    ...
    if (!$query){
      ...
      while ($company = mysqli_fetch_array($query)){
        ...
        $functions .= '<li class="function_edit"><a data-id="'   . $company['id_unidades_negocio'] . '" data-name="' . $company['unidad_negocio'] . '"><span>Edit</span></a></li>';
        $functions .= '<li class="function_delete"><a data-id="' . $company['id_unidades_negocio'] . '" data-name="' . $company['unidad_negocio'] . '"><span>Delete</span></a></li>';
