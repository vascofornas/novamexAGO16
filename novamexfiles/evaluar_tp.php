...
$(document).ready(function() {
    ...
    $("#submit_btn").click(function() { 
        ...
        if(proceed) //everything looks good! proceed...
        {
            ...
            $.post('evaluar_tareas_proactividad.php', post_data, function(response){  
...
<div class = "container">
<h2><?php echo $lang['EVALUACION_TAREAS']?></h2>
...
<h2 align="center"><?php echo  $row_Recordset3['nombre_revision']." -> ".$row_Recordset3['fecha_inicio_tareas_proactividad'];?></h2>
<br>
<div class="row">
...
{
	$num = $num+1;
	echo $num." - ".$row_proyectos['fecha_entregable']." - ".$row_proyectos['titulo_entregable'].'  <a href="entregables_tareas_proactividad/'.$row_proyectos['nombre_entregable'].' "  target="_blank"  class="btn btn-info btn-lg active " role="button" > <span class="glyphicon glyphicon-download-alt"></span></a><br><br>';;
}
    ?>
	...
	<div class="col-md-6">
		<div class="form-group">
                      ...
                      <h4><?php echo  get_nombre($row_Recordset3['cliente_tareas_proactividad']);?></h4>
                      <input type="hidden" class="form-control" id="eval_id" name="eval_id" placeholder="Enter ..." disabled value="<?php echo $_GET['id'];?>">
      
                      <input type="hidden" class="form-control" id="proveedor" name="proveedor" placeholder="Enter ..." disabled value="<?php echo $row_Recordset3['proveedor_tareas_proactividad'];?>">
        </div>
	</div>

	<div class="col-md-6">
		<div class="form-group">
                      <label><?php echo $lang['EVALUATED']?></label>
                      <h4><?php echo  get_nombre($row_Recordset3['proveedor_tareas_proactividad']);?></h4>
...
<div class="col-md-6">
         ...
         <div class="form-group">
                      <label><?php echo $lang['TITLE_PT']?></label>
                      <h4><?php echo $row_Recordset3['titulo_tareas_proactividad'];?></h4>
                      <input type="hidden" name="titulo" id="titulo" class="form-control" placeholder="<?php echo $lang['TITLE_PT']?> ...">
                    </div>I
 ...
 <div class="col-md-6">
         ...
         <div class="form-group">
                      <label><?php echo $lang['DESC_PT']?></label>
                      <h4><?php echo get_descripcion_pt($row_Recordset3['tareas_proactividad_revisado']);?></h4>
	...
	<div class="col-md-12">
		<div class="form-group">
                   ...
                   <h4><?php echo $row_Recordset3['fecha_inicio_tareas_proactividad'];?></h4>
                      <input type="hidden" name="titulo" id="titulo" class="form-control" placeholder="<?php echo $lang['TITLE_REQ']?> ...">
                    </div>
...
<div class="col-md-6">
 ...
 <div class="col-md-6">
         ...
         <div class="form-group">
                      <label><?php echo $lang['EVALUACION_TAREAS']." (".$row_Recordset3['evaluacion_c1']." pts)"?></label>
                    
                    <select id="eval_c1" name="eval_c1" class="form-control select2" style="width: 100%;">
                      <option  value="<?php echo get_na_tp($row_Recordset3['tareas_proactividad_revisado'])?>"><?php echo $lang['NO_ANSWER_POINTS']." (". get_na_tp($row_Recordset3['tareas_proactividad_revisado']).")"?></option>
                      <option value="<?php echo get_el_tp($row_Recordset3['tareas_proactividad_revisado'])?>"><?php echo $lang['ESFUERZO_LEVE']." (". get_el_tp($row_Recordset3['tareas_proactividad_revisado']).")"?></option>
                     <option  value="<?php echo get_ea_tp($row_Recordset3['tareas_proactividad_revisado'])?>"><?php echo $lang['ESFUERZO_ACEPTABLE']." (". get_ea_tp($row_Recordset3['tareas_proactividad_revisado']).")"?></option>
                      <option value="<?php echo get_ee_tp($row_Recordset3['tareas_proactividad_revisado'])?>"><?php echo $lang['ESFUERZO_EXCEPCIONAL']." (". get_ee_tp($row_Recordset3['tareas_proactividad_revisado']).")"?></option>
...
<div class="col-md-6">
 ...
 <div class="col-md-6">
         ...
         <div class="form-group">
                      <label><?php echo $lang['EVALUACION_TAREAS']." (".$row_Recordset3['evaluacion_c2']." pts)"?></label>
...
<div class="col-md-6">
 ...
 <div class="col-md-6">
         ...
         <div class="form-group">
                      <label><?php echo $lang['EVALUACION_TAREAS']." (".$row_Recordset3['evaluacion_c3']." pts)"?></label>
...
<div class="col-md-6">
 ...
 <div class="col-md-6">
         ...
         <div class="form-group">
                      <label><?php echo $lang['EVALUACION_TAREAS']." (".$row_Recordset3['evaluacion_c4']." pts)"?></label>
