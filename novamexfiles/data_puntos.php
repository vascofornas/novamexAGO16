...
if ($job != ''){
  ...
  if ($job == 'get_companies'){
    ...
    // Get companies
    $query = "SELECT * FROM tb_puntos_disponibles ORDER BY puntos_conseguidos  ";
    ...
    if (!$query){
      ...
      while ($company = mysqli_fetch_array($query)){
        ...
        $usuario = get_nombre($company['usuario_puntos_disponibles']);
       
        
        $mysql_data[] = array(
         
          "usuario"  => $usuario,
        		"puntos"    => $company['puntos_conseguidos'],
        		
        		"canjeados"    => $company['puntos_canjeados']
