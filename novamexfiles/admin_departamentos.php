...
<div class="fixed">
  ...
  if ($idioma_actual == "es"){?>
  <a href="admin_departamentos.php?lang=es"><img src="mexico.png" width="45" height="45" /></a>
<a href="admin_departamentos.php?lang=en"><img src="usa.png" width="30" height="30" /></a>
  <?php }
  if ($idioma_actual == "en"){?>
  <a href="admin_departamentos.php?lang=en"><img src="usa.png" width="45" height="45" /></a>
  <a href="admin_departamentos.php?lang=es"><img src="mexico.png" width="30" height="30" /></a>
...
<div class="input_container">
        <label for="unidad_negocio"><?php echo $lang['BUSINESS_UNIT']?>: <span class="required">*</span></label>
            <div class="styled-select slate">
              <select  id="unidad_negocio_departamento" name="unidad_negocio_departamento" class="selectpicker"  required>
