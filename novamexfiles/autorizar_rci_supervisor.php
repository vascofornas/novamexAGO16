<?php 
  ...
  include_once 'funciones.php';
	...
	//add log
	$texto = "SUPERVISOR AUTORIZA REQUERIMIENTO DE CLIENTE INTERNO";
	$codigo = "041";
	...
	if ($idioma_cliente_interno == "en"){
		...
		$subject = "AUTHORIZED BY SUPERVISOR. You have been assigned as client to an INTERNAL CUSTOMER REQUIREMENT ";
		...
		$subject = "AUTORIZADO POR SUPERVISOR. Te han asignado como cliente en un REQUERIMIENTO DE CLIENTE INTERNO";
		send_mail($email_cliente_interno,$message,$subject);
	...
	if ($proveedor_interno == "en"){
		...
		$subjectp = "AUTHORIZED BY SUPERVISOR. You have been assigned as Internal Provider  to an INTERNAL CUSTOMER REQUIREMENT ";
		...
		$subjectp = "AUTORIZADO POR SUPERVISOR. Te han asignado como proveedor en un REQUERIMIENTO DE CLIENTE INTERNO";
		send_mail($email_proveedor_interno,$messagep,$subjectp);
...
$em = get_email_superadmin();
		...
		$messagep .= "<br><br>Best regards.<br> Your NOVAMEX Team";
		$subjectp = "AUTORIZADO POR EL  SUPERVISOR.";
	...
	$sql = "UPDATE tb_requerimientos_cliente_interno SET approved_by_supervisor = 1 WHERE id_req_interno= '".$id."'";
