...
if( $_POST ){
   ...
   $proyecto_entregable = $_POST['tareas_proactividad_entregable'];
...
$sql = "INSERT INTO tb_entregables_tareas_proactividad (titulo_entregable, descripcion_entregable, tareas_proactividad_entregable, nombre_entregable)
