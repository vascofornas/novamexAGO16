...
<div class = "container">
  ...
  <div class="col-sm-5 col-md-5 col-lg-5" style="background-color:Azure   ;"><H3><?php echo $lang['OTHER_PROJECTS']?></H3>
  <HR>
...
?>
   ...
   <div class="col-sm-5 col-md-5 col-lg-5" style="background-color:AntiqueWhite  ;"><H3><?php echo $lang['OTHER_PROJECTS']?></H3>
  <HR>
...
<?php
echo '<a href="tor_select_rubro.php"     class="btn btn-danger btn-lg active confirmation" role="button" >'.$lang['CREAR_OR'].'</a><br><br>';
