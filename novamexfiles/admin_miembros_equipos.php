...
<link rel="stylesheet" href="//fonts.googleapis.com/css?family=Oxygen:400,700">
    ...
    <script charset="utf-8" src="webapp_miembros_equipos.js"></script>
...
<div class="bs-example">
  ...
  if ($idioma_actual == "es"){?>
  <a href="admin_miembros_equipos.php?lang=es"><img src="mexico.png" width="45" height="45" /></a>
<a href="admin_miembros_equipos.php?lang=en"><img src="usa.png" width="30" height="30" /></a>
  <?php }
  if ($idioma_actual == "en"){?>
  <a href="admin_miembros_equipos.php?lang=en"><img src="usa.png" width="45" height="45" /></a>
  <a href="admin_miembros_equipos.php?lang=es"><img src="mexico.png" width="30" height="30" /></a>
...
<div class="container">
    ...
    <p>&nbsp;</p>
    <h1 align="center"><?php echo $lang['TEAM_MEMBERS']?></h1>
    <p align="center">&nbsp;</p>
    ...
    <div class="lightbox_container">
      ...
      <div class="lightbox_content">
        ...
        <h2><?php echo $lang['ADD_TEAM_MEMBER']?></h2>
...
<div class="input_container">
        ...
        <?php   if ($resultuser=mysqli_query($conexion,$sqlUSER))
  {
...
<div class="input_container">
        <label for="equipo"><?php echo $lang['TEAM']?>: <span class="required">*</span></label>
            <div class="styled-select slate">
              <select  id="equipo" name="equipo" class="selectpicker"  required>
           
           
        <?php   if ($resultBU=mysqli_query($conexion,$sqlBU))
  {
  // Fetch one and one row
  ...
  mysqli_free_result($resultBU);
     ...
     ?>           
           ...
           <div class="input_container">
            <label for="fecha_alta"><?php echo $lang['START_DATE']?>: <span class="required">*</span></label>
            <div class="field_container">
              <input type="text" class="text" name="fecha_alta" id="fecha_alta" value="" required>
            </div>
          </div>
          <div class="input_container">
          ...
          <div class="button_container">
            <button type="submit"><?php echo $lang['ADD_TEAM_MEMBER']?></button>
          </div>
        </form>
