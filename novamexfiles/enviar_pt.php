...
if($_POST)
{
    ...
    $sql = "INSERT INTO tb_tareas_proactividad (cliente_tareas_proactividad,
    		supervisor_tareas_proactividad,
    		proveedor_tareas_proactividad,
    		
    		titulo_tareas_proactividad,
    		descripcion_tareas_proactividad,
    		fecha_inicio_tareas_proactividad,
