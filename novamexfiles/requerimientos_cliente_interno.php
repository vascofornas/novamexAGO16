...
//run the query
	...
	if ($row_miembros['proveedor_rci'] == $row['userID'])
	{
echo "<strong><a href='rci_evaluado.php?id=".$row_miembros['id_revisiones_rci']."'>".$row_miembros['nombre_revision'] ."</strong></a><br> " . $row_miembros['titulo_rci']."<bR>".$row_miembros['fecha_inicio_rci']."<hr>";
	}
	else{}
	}
