...
<link rel="stylesheet" href="//fonts.googleapis.com/css?family=Oxygen:400,700">
    ...
    <script charset="utf-8" src="webapp_equipos.js"></script>
...
<div class="bs-example">
  ...
  if ($idioma_actual == "es"){?>
  <a href="admin_equipos.php?lang=es"><img src="mexico.png" width="45" height="45" /></a>
<a href="admin_equipos.php?lang=en"><img src="usa.png" width="30" height="30" /></a>
  <?php }
  if ($idioma_actual == "en"){?>
  <a href="admin_equipos.php?lang=en"><img src="usa.png" width="45" height="45" /></a>
  <a href="admin_equipos.php?lang=es"><img src="mexico.png" width="30" height="30" /></a>
...
<div class="container">
    ...
    <p>&nbsp;</p>
    <h1 align="center"><?php echo $lang['TEAMS']?></h1>
    <p align="center">&nbsp;</p>
    <div id="page_container">
      ...
      <div align="center">
        <button type="button" class="button" id="add_company"><?php echo $lang['ADD_TEAM']?></button>
      ...
      <div class="lightbox_content">
        ...
        <form class="form add" id="form_company" data-id="" novalidate>
          ...
          <div class="input_container">
            <label for="nombre_equipo"><?php echo $lang['TEAM_NAME']?>: <span class="required">*</span></label>
            <div class="field_container">
              <input type="text" class="text" name="nombre_equipo" id="nombre_equipo" value="" required>
            </div>
          </div>
...
<div class="input_container">
        <label for="unidad_negocio_equipo"><?php echo $lang['BUSINESS_UNIT']?>: <span class="required">*</span></label>
            <div class="styled-select slate">
              <select  id="unidad_negocio_equipo" name="unidad_negocio_equipo" class="selectpicker"  required>
  ...
  mysqli_free_result($result);
     ...
     ?>           
           ...
           <div class="input_container">
            <label for="fecha_creacion"><?php echo $lang['CREATION_DATE']?>: <span class="required">*</span></label>
            <div class="field_container">
              <input type="text" class="text" name="fecha_alta_equipo" id="fecha_alta_equipo" value="" required>
            </div>
          </div>
       
         
          <div class="button_container">
            <button type="submit"><?php echo $lang['ADD_TEAM']?></button>
          </div>
        </form>
