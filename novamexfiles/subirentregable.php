...
$file_upload="false";
   ...
   $str =preg_replace('~&([a-z]{1,2})(acute|cedil|circ|grave|lig|orn|ring|slash|th|tilde|uml);~i', '$1', htmlentities($str, ENT_QUOTES, 'UTF-8'));
	move_uploaded_file($_FILES['userfile']['tmp_name'],"entregables_proyectos/".$prefijo.$str);
	?>
	  <script>
...
<form id="form1" name="form1" method="post" action="subirentregable.php" data-ajax="false" enctype="multipart/form-data">
