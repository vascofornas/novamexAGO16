...
VALUES ('$id','Revision # .$num')";
	...
	if ($porcentaje5 == 1){
		...
		$sql5 = "INSERT INTO tb_evaluaciones_proyectos (revision_evaluada,porcentaje_evaluado,opcion_evaluada,proyecto_evaluado,puntos_evaluados)
		VALUES ('$last_id','$porcentajetipo5','$opcion5','$id','$puntostotales5')";
	...
	if ($porcentaje6 == 1){
		...
		$sql6 = "INSERT INTO tb_evaluaciones_proyectos (revision_evaluada,porcentaje_evaluado,opcion_evaluada,proyecto_evaluado,puntos_evaluados)
		VALUES ('$last_id','$porcentajetipo6','$opcion6','$id','$puntostotales6')";
	...
	if ($porcentaje7 == 1){
		...
		$sql7 = "INSERT INTO tb_evaluaciones_proyectos (revision_evaluada,porcentaje_evaluado,opcion_evaluada,proyecto_evaluado,puntos_evaluados)
		VALUES ('$last_id','$porcentajetipo7','$opcion7','$id','$puntostotales7')";
	...
	if ($porcentaje8 == 1){
		...
		$sql8 = "INSERT INTO tb_evaluaciones_proyectos (revision_evaluada,porcentaje_evaluado,opcion_evaluada,proyecto_evaluado,puntos_evaluados)
		VALUES ('$last_id','$porcentajetipo5','$opcion5','$id','$puntostotales5')";
	...
	if ($porcentaje9 == 1){
		...
		$sql9 = "INSERT INTO tb_evaluaciones_proyectos (revision_evaluada,porcentaje_evaluado,opcion_evaluada,proyecto_evaluado,puntos_evaluados)
		VALUES ('$last_id','$porcentajetipo9','$opcion9','$id','$puntostotales9')";
	...
	if ($porcentaje10 == 1){
		...
		$sql10 = "INSERT INTO tb_evaluaciones_proyectos (revision_evaluada,porcentaje_evaluado,opcion_evaluada,proyecto_evaluado,puntos_evaluados)
		VALUES ('$last_id','$porcentajetipo10','$opcion10','$id','$puntostotales10')";
