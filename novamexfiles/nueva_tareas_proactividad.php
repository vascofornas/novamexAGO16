...
$(document).ready(function() {
    ...
    $("#submit_btn").click(function() { 
        ...
        if(proceed) //everything looks good! proceed...
        {
            ...
            $.post('enviar_pt.php', post_data, function(response){  
...
<div class = "container">
<h2><?php echo $lang['CREATE_NEW_TA']?></h2>
...
<div class="row">
	...
	<div class="col-md-6">
		<div class="form-group">
                      ...
                      <input type="hidden" class="form-control" id="supervisor" name="supervisor" placeholder="Enter ..." disabled value="<?php echo $_SESSION['userSession'];?>">
        </div>
	</div>
	...
	<div class="col-md-6">
		...
		<?php   $sqlBU="SELECT * FROM tbl_users WHERE supervisor_usuario = '".$_SESSION['userSession']."' ORDER BY nombre_usuario";?>
...
<div class="col-md-6">
         ...
         <div class="form-group">
                      ...
                      <input type="text" name="titulo" id="titulo" class="form-control" placeholder="<?php echo $lang['TITLE_PT']?> ...">
                    </div>
 ...
 <div class="form-group">
                      ...
                      <textarea class="form-control" id="texto" name="texto" rows="3" placeholder="<?php echo $lang['DESC_PT']?>..."></textarea>
 </div>
