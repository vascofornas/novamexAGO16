...
<link rel="stylesheet" href="//fonts.googleapis.com/css?family=Oxygen:400,700">
    ...
    <script charset="utf-8" src="webapp_config.js"></script>
...
<div class="container">
    ...
    <p>&nbsp;</p>
    <h1 align="center"><?php echo $lang['SETUP']?></h1>
    <p align="center">&nbsp;</p>
      ...
      <div class="lightbox_content">
        ...
        <form class="form add" id="form_company" data-id="" novalidate>
          ...
          <div class="input_container">
            <label for="unidad_negocio">SUPERADMIN EMAIL: <span class="required">*</span></label>
            <div class="field_container">
              <input type="text" class="text" name="superadmin_email" id="superadmin_email" value="" required>
            </div>
          </div>
